...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        world.add(new Sphere(new Vector3(-2.5, 0, 0), 2, new Diffuse(Color.RED)));
        world.add(new Sphere(new Vector3(2.5, 0, 0), 2, new Diffuse(Color.GREEN)));
        world.add(new Sphere(new Vector3(0, 0, 2.5), 2, new Ambient(Color.BLUE)));
        world.add(new Plane(new Vector3(0, 0, 0), new Vector3(0,1,0), new Diffuse(Color.GRAY)));
