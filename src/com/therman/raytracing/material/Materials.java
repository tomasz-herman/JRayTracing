...
public class Materials {
    ...
    public final static Material STEEL = new Reflective(new Specular(new Diffuse(new Ambient(Color.mul(steel, 0.25)), steel), steel, 40), Color.mul(steel, 0.12));
    private final static Color gold = new Color(1, 0.8, 0);
    public final static Material GOLD = new Reflective(new Specular(new Diffuse(new Ambient(Color.mul(gold, 0.25)), gold), gold, 20), Color.mul(gold, 0.1));
